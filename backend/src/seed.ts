...
const seed = async () => {
  ...
  await TeamMember.insertMany([
    // Board of Directors
    { nameEn: 'Dr. Ahmad Al-Rashidi', nameAr: 'د. أحمد الرشيدي', roleEn: 'Chairman of the Board', roleAr: 'رئيس مجلس الإدارة', bioEn: 'Over 25 years of experience in education leadership and strategic management.', bioAr: 'أكثر من ٢٥ عامًا من الخبرة في القيادة التعليمية والإدارة الاستراتيجية.', imageUrl: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=300&h=300&fit=crop&crop=face', category: 'board', order: 0 },
    { nameEn: 'Mrs. Fatima Hassan', nameAr: 'أ. فاطمة حسن', roleEn: 'Vice Chairwoman', roleAr: 'نائبة الرئيس', bioEn: 'Passionate advocate for bilingual education and women empowerment in Saudi Arabia.', bioAr: 'مناصرة شغوفة للتعليم ثنائي اللغة وتمكين المرأة في المملكة العربية السعودية.', imageUrl: 'https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?w=300&h=300&fit=crop&crop=face', category: 'board', order: 1 },
    { nameEn: 'Mr. Khalid Al-Otaibi', nameAr: 'أ. خالد العتيبي', roleEn: 'Board Member', roleAr: 'عضو مجلس الإدارة', bioEn: 'Entrepreneur and philanthropist dedicated to improving education quality.', bioAr: 'رجل أعمال ومحسن مكرّس لتحسين جودة التعليم.', imageUrl: 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=300&h=300&fit=crop&crop=face', category: 'board', order: 2 },
    { nameEn: 'Dr. Sarah Al-Zahrani', nameAr: 'د. سارة الزهراني', roleEn: 'Board Member', roleAr: 'عضوة مجلس الإدارة', bioEn: 'PhD in Educational Psychology with a focus on child development.', bioAr: 'دكتوراه في علم النفس التربوي مع تركيز على نمو الطفل.', imageUrl: 'https://images.unsplash.com/photo-1580489944761-15a19d654956?w=300&h=300&fit=crop&crop=face', category: 'board', order: 3 },
    // Leadership Team
    { nameEn: 'Mr. Omar Badr', nameAr: 'أ. عمر بدر', roleEn: 'School Principal', roleAr: 'مدير المدرسة', bioEn: 'Leading MEYLOR with 15+ years of international school management experience.', bioAr: 'يقود ميلور بخبرة تزيد عن ١٥ عامًا في إدارة المدارس الدولية.', imageUrl: 'https://images.unsplash.com/photo-1560250097-0b93528c311a?w=300&h=300&fit=crop&crop=face', category: 'leadership', order: 0 },
    { nameEn: 'Mrs. Layla Mansour', nameAr: 'أ. ليلى منصور', roleEn: 'Vice Principal - Academics', roleAr: 'نائبة المدير - الشؤون الأكاديمية', bioEn: 'Expert in curriculum design and teacher development programs.', bioAr: 'خبيرة في تصميم المناهج وبرامج تطوير المعلمين.', imageUrl: 'https://images.unsplash.com/photo-1594824476967-48c8b964ac31?w=300&h=300&fit=crop&crop=face', category: 'leadership', order: 1 },
    { nameEn: 'Mr. Faisal Al-Harbi', nameAr: 'أ. فيصل الحربي', roleEn: 'Vice Principal - Operations', roleAr: 'نائب المدير - العمليات', bioEn: 'Ensuring smooth daily operations and maintaining the highest facility standards.', bioAr: 'ضمان سير العمليات اليومية بسلاسة والحفاظ على أعلى معايير المرافق.', imageUrl: 'https://images.unsplash.com/photo-1519085360753-af0119f7cbe7?w=300&h=300&fit=crop&crop=face', category: 'leadership', order: 2 },
    { nameEn: 'Mrs. Nora Al-Qahtani', nameAr: 'أ. نورة القحطاني', roleEn: 'Head of Student Affairs', roleAr: 'رئيسة شؤون الطلاب', bioEn: 'Dedicated to student wellbeing and creating a positive school culture.', bioAr: 'مكرّسة لرفاهية الطلاب وخلق ثقافة مدرسية إيجابية.', imageUrl: 'https://images.unsplash.com/photo-1551836022-d5d88e9218df?w=300&h=300&fit=crop&crop=face', category: 'leadership', order: 3 },
    { nameEn: 'Dr. Rami Tawfiq', nameAr: 'د. رامي توفيق', roleEn: 'Head of Curriculum', roleAr: 'رئيس المناهج', bioEn: 'PhD holder with extensive experience in bilingual curriculum development.', bioAr: 'حامل دكتوراه مع خبرة واسعة في تطوير المناهج ثنائية اللغة.', imageUrl: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=300&h=300&fit=crop&crop=face', category: 'leadership', order: 4 },
    { nameEn: 'Mrs. Hana Al-Shehri', nameAr: 'أ. هناء الشهري', roleEn: 'Head of Admissions', roleAr: 'رئيسة القبول والتسجيل', bioEn: 'Guiding families through the enrollment process with care and professionalism.', bioAr: 'توجيه الأسر خلال عملية التسجيل بعناية واحترافية.', imageUrl: 'https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=300&h=300&fit=crop&crop=face', category: 'leadership', order: 5 },
  ]);
